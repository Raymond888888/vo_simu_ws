...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber imageDataSub = nh.subscribe<sensor_msgs::Image>("/thermal_camera_example", 1, imageDataHandler); //hik_cam_node/hik_camera /camera/image_raw
